...
const vnOffers = (rewardId: string | null): FunnelOffer[] => [
  {
    ...
    currency: 'VND',
    label: '1 tháng',
    description: 'Linh hoạt để bắt đầu',
    period_unit: 'MONTH',
    period_count: 1,
    ...
    renewal_description: '99.000đ mỗi tháng',
  ...
  },
  {
    ...
    currency: 'VND',
    label: '3 tháng',
    description: 'Đủ dài để tạo nhịp theo dõi',
    period_unit: 'MONTH',
    period_count: 3,
    standard_amount: 398_000,
    welcome_amount: 199_000,
    amount_due_today: 199_000,
    renewal_amount: 199_000,
    renewal_description: '199.000đ mỗi 3 tháng',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
  ...
  },
  {
    ...
    currency: 'VND',
    label: '6 tháng',
    description: 'Theo dõi lâu hơn, ít gián đoạn hơn',
    period_unit: 'MONTH',
    period_count: 6,
    standard_amount: 598_000,
    welcome_amount: 299_000,
    amount_due_today: 299_000,
    renewal_amount: 299_000,
    renewal_description: '299.000đ mỗi 6 tháng',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
...
const intlOffers = (rewardId: string | null): FunnelOffer[] => [
  {
    ...
    currency: 'USD',
    label: '1 month',
    description: 'Start with monthly flexibility',
    period_unit: 'MONTH',
    period_count: 1,
    ...
    renewal_amount: 4.99,
    renewal_description: '$4.99 monthly',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
  ...
  },
  {
    ...
    currency: 'USD',
    label: '3 months',
    description: 'Recommended for a full starting rhythm',
    period_unit: 'MONTH',
    period_count: 3,
    ...
    renewal_amount: 9.99,
    renewal_description: '$9.99 every 3 months',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
  ...
  },
  {
    ...
    currency: 'USD',
    label: '12 months',
    description: 'Best for a full year of consistency',
    period_unit: 'YEAR',
    period_count: 1,
    ...
    renewal_description: '$19.99 yearly',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
