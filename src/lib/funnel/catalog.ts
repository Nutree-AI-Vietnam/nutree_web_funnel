...
const vnOffers = (rewardId: string | null): FunnelOffer[] => [
  {
    ...
    renewal_amount: 198_000,
    renewal_description: '198.000đ mỗi 4 tuần',
  ...
  },
  {
    ...
    renewal_amount: 498_000,
    renewal_description: '498.000đ mỗi 12 tuần',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
  ...
  },
  {
    ...
    renewal_amount: 1_198_000,
    renewal_description: '1.198.000đ mỗi 52 tuần',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
...
const intlOffers = (rewardId: string | null): FunnelOffer[] => [
  {
    ...
    period_unit: 'MONTH',
    period_count: 1,
    standard_amount: 7.99,
    welcome_amount: 3.99,
    amount_due_today: 3.99,
    renewal_amount: 7.99,
    renewal_description: '$7.99 every 4 weeks',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
  ...
  },
  {
    ...
    period_unit: 'YEAR',
    period_count: 1,
    standard_amount: 47.99,
    welcome_amount: 23.99,
    amount_due_today: 23.99,
    renewal_amount: 47.99,
    renewal_description: '$47.99 every 52 weeks',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
