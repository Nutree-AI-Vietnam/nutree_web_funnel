...
const intlOffers = (rewardId: string | null): FunnelOffer[] => [
  {
    ...
    renewal_amount: 9.98,
    renewal_description: '$9.98 every 4 weeks',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
  ...
  },
  {
    ...
    renewal_amount: 19.98,
    renewal_description: '$19.98 every 12 weeks',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
  ...
  },
  {
    ...
    renewal_amount: 39.98,
    renewal_description: '$39.98 every 52 weeks',
    next_billing_date: nextBillingDate(),
    reward_id: rewardId,
    reward_applied: true,
    price_locked_while_active: true,
