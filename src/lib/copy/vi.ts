...
export const vi = {
  ...
  paywall: {
    ...
    subhead: 'Chọn gói phù hợp với bạn. Huỷ bất cứ lúc nào trong app.',
    ...
    totalPrefix: 'Tổng',
    recommendedTag: 'Đáng giá nhất',
    perDayNote: (perDay: string) => `Chỉ khoảng ${perDay}đ mỗi ngày`,
    socialProof: 'Cùng nhiều người đang xây kế hoạch để theo được lâu dài.',
    bullets: [
    ...
    finePrint: 'Gia hạn tự động. Không có free trial. Huỷ bất cứ lúc nào.',
    cta: 'Mở khóa kế hoạch',
