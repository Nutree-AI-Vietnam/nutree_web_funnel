...
export const vi = {
  ...
  email: {
    ...
    body: 'Nhập email để nhận lại kế hoạch, khôi phục thanh toán nếu bị gián đoạn, và mở kế hoạch trong ứng dụng Nutree. Bước tiếp theo là cào để mở giá chào mừng trước khi chọn gói Premium.',
  ...
  welcomeGift: {
    ...
    discount: '50%',
    ticketBody: 'Giá chào mừng được giữ khi gói còn hoạt động',
    priceLine: (amount: string, plan: string, renewal: string) =>
      `${amount} cho gói ${plan}. ${renewal} được giữ khi gói còn hoạt động.`,
    cta: 'Xem các gói giảm 50%',
    lockedCta: 'Mở giá trước',
  },
  paywall: {
    headline: (name: string) => `Mở khóa kế hoạch ${name} vừa xây dựng`,
    fallbackName: 'bạn',
    subhead: 'Kế hoạch này dùng mục tiêu, dữ liệu cơ thể và lịch sinh hoạt bạn vừa cung cấp.',
    rewardBanner: 'Giảm 50% đã được áp dụng cho cả 3 gói',
    providerLabel: (country: string) => `Thanh toán qua MoMo · ${country}`,
    paypalLabel: (country: string) => `Secure payment with PayPal · ${country}`,
    countryChange: 'Không đúng quốc gia? Thay đổi',
    selectPlanAria: 'Chọn gói',
    standardPrice: 'Giá chuẩn',
    todayPrice: 'Thanh toán hôm nay',
    renewal: 'Gia hạn',
    recommendedTag: 'Khuyến nghị',
    lockNote: 'Giữ giá ưu đãi khi gói còn hoạt động',
    termsIntro: 'Không có free trial. Bạn có thể hủy gia hạn theo điều khoản của nhà cung cấp.',
    bullets: [
      'Mục tiêu calo & macro cá nhân hóa',
      'Ghi bữa ăn nhanh bằng ảnh',
      'Ngân sách ngày và tuần tự cập nhật',
    ],
    secure: 'Thanh toán an toàn. Entitlement chỉ mở sau khi nhà cung cấp xác nhận.',
    cta: (amount: string, provider: string) => `Thanh toán ${amount} bằng ${provider}`,
