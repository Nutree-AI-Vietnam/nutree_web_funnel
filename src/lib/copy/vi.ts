...
export const vi = {
  ...
  email: {
    ...
    body: 'Nhập email để giữ kế hoạch này và tiếp tục đến bước mở khóa. Bước tiếp theo là Nutree Premium, không có free trial.',
    placeholder: 'email@vidu.com',
    cta: 'Lưu kế hoạch và tiếp tục',
    skip: 'Bỏ qua, xem bước tiếp theo',
    invalid: 'Email không hợp lệ',
    error: 'Có lỗi xảy ra. Vui lòng thử lại.',
  },
  welcomeGift: {
    eyebrow: 'Quà chào mừng',
    headline: 'Quà chào mừng của bạn đã sẵn sàng',
    subhead: 'Mở vé này để giữ ưu đãi đầu tiên cho kế hoạch cá nhân Nutree.',
    ticketAria: 'Nhận quà chào mừng 50 phần trăm',
    scratchAria: 'Cào vé để mở ưu đãi chào mừng',
    scratchHint: 'Cào để mở quà',
    ticketLabel: 'Quà chào mừng',
    discount: '50% OFF',
    ticketBody: 'Giá khởi đầu của bạn đã mở khóa',
    cta: 'Nhận quà',
    lockedCta: 'Cào vé để nhận quà',
  },
  paywall: {
    eyebrow: 'Kế hoạch cá nhân của bạn',
    headline: 'Bạn có thể bắt đầu nhẹ hơn ngay hôm nay',
    subhead: 'Quà chào mừng đã mở ưu đãi đầu tiên. Gói 12 tuần được chọn vì đủ dài để thấy tiến độ rõ ràng.',
    finalGiftEyebrow: 'Quà cuối cùng đã mở',
    finalSubhead: 'Vì bạn đã thử thanh toán, Nutree giữ lại mức thấp nhất cho lần này.',
    offerBanner: 'Ưu đãi này kết thúc trong: 09:52',
    finalOfferBanner: 'Quà cuối cùng đã áp dụng cho cả 3 gói',
    topCta: 'Nhận kế hoạch',
    timer: {
      discount: '50%',
      reserved: 'đã giữ cho bạn:',
      time: '09:52',
      finalTime: '04:59',
    },
    ...
    plans: [
      ...
      },
      {
        ...
        periodDays: 364,
        perMonth: 49_000,
        badge: 'Tiết kiệm nhiều',
        recommended: false,
      },
    ],
    perMonthSuffix: 'đ/tháng',
    totalPrefix: 'Tổng',
    recommendedTag: 'Phổ biến nhất',
    perDayNote: (perDay: string) => `Chỉ khoảng ${perDay}đ mỗi ngày`,
    socialProof: 'Người dùng có mục tiêu tương tự thường đi xa hơn khi bắt đầu ngay sau khi nhận kế hoạch.',
    bullets: [
      'Mục tiêu calo & macro cá nhân hóa',
      'Gợi ý bữa ăn AI mỗi ngày',
      'Theo dõi tiến độ & điều chỉnh tự động',
    ],
    secure: 'Thanh toán được mã hóa an toàn',
    finePrint: 'Gia hạn tự động sau tháng đầu. Không có free trial. Huỷ bất cứ lúc nào.',
    ctaPrefix: 'Nhận gói',
    finalCtaPrefix: 'Nhận quà cuối cho gói',
