...
export const vi = {
  ...
  body_review: {
    question: 'Nutree đã ghi nhận thông tin của bạn',
    hint: 'Dùng để tính kế hoạch. Không cần rà từng dòng — bấm tiếp là được.',
    cta: 'Tiếp tục',
    goalLabel: 'Mục tiêu',
    ageLabel: 'Tuổi',
    heightLabel: 'Chiều cao',
  ...
  science: {
    ...
    headline: 'Bạn trả lời. Nutree tính hộ.',
    hint: 'Không cần hiểu TDEE hay macro. Cứ bấm tiếp.',
    items: [
      {
        title: 'TDEE — Năng lượng tiêu hao',
        body: 'Nutree ước calo mỗi ngày từ cơ thể của bạn. Bạn không phải tự tính.',
        icon: '⚡',
      },
      {
        title: 'BMI — Chỉ số khối cơ thể',
        body: 'Một mốc tham khảo để kế hoạch vừa sức hơn — không phải bài kiểm tra.',
        icon: '📐',
      },
      {
        title: 'Macro — Chia dinh dưỡng',
        body: 'Protein, carb và fat được chia sẵn theo mục tiêu. Bạn chỉ việc làm theo.',
        icon: '🎯',
      },
    ],
    slides: [
      {
        title: 'Calo được tính sẵn',
        body: 'Từ cơ thể, mục tiêu và vận động của bạn. Bạn không phải tự tính.',
        metric: 'Tự động',
      },
      {
        title: 'Bữa ăn theo kế hoạch',
        body: 'Nutree gợi ý cách ăn. Bạn chỉ việc làm theo.',
        metric: 'Dễ ăn',
      },
      {
        title: 'Có thể chỉnh sau',
        body: 'Đây là điểm bắt đầu, không phải bài kiểm tra.',
        metric: 'Linh hoạt',
      },
    ],
