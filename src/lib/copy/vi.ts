...
export const vi = {
  ...
  paywall: {
    ...
    exitOfferTitle: 'Khoan rời đi — nhận ưu đãi giảm 75%',
    exitOfferBody: 'Giữ kế hoạch cá nhân với mức giá đặc biệt một lần khi bạn quay lại.',
    exitOfferEyebrow: 'Ưu đãi rời đi',
    exitOfferScratchSubhead: 'Cào để mở mức giá đặc biệt.',
    exitOfferRevealedHeadline: 'Đã mở ưu đãi giảm 75%',
    exitOfferTicketAria: 'Ưu đãi giảm 75% đã được mở',
    exitOfferScratchAria: 'Cào thẻ để mở ưu đãi giảm 75%',
    exitOfferScratchHint: 'Cào hoặc chạm để mở',
    exitOfferCta: 'Nhận giảm 75%',
    exitOfferLockedCta: 'Mở ưu đãi trước',
    exitOfferDismiss: 'Không, cảm ơn',
